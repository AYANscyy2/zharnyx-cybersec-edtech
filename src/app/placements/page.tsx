...
export const metadata = {
  title: "Placements & Careers | Zharnyx Academy",
  description: "Structured placement support — not just a certificate. We help you get hired.",
};
    ...
    <div className="relative min-h-screen pt-32 pb-20 overflow-hidden font-mono bg-black text-white">
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col items-center gap-24">
        ...
        <section className="flex flex-col items-center text-center max-w-3xl space-y-6">
          <div className="flex items-center gap-2 px-4 py-1 bg-white text-black font-bold uppercase tracking-widest text-xs border-2 border-white shadow-[4px_4px_0px_0px_red]">
        ...
        {/* Hiring Partners (Brutalist Marquee style concepts) */}
        ...
        <section className="w-full space-y-8">
          ...
          <div className="bg-black border-2 border-white/20 p-1 divide-y-2 divide-white/20">
