...
export default function CurriculumPage() {
  ...
  return (
    <div className="relative min-h-screen pt-32 pb-20 font-sans bg-black text-white">
      {/* Background Accent */}
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col items-center gap-12">
        ...
        <section className="flex flex-col items-center text-center max-w-3xl space-y-6">
          <div className="flex items-center gap-2 px-4 py-1.5 bg-white text-black font-bold uppercase tracking-widest text-xs border-2 border-white shadow-[4px_4px_0px_0px_red]">
