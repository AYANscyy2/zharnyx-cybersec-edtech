...
export const metadata = {
  ...
  description: "7 Months. 4 Tracks. 100% Hands-On Cybersecurity Training.",
};

export default function ProgramsPage() {
  return (
    <div className="relative min-h-screen pt-32 pb-20 overflow-hidden font-mono">
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col items-center gap-16">
        ...
        <section className="flex flex-col items-center text-center max-w-4xl space-y-6">
          ...
          <p className="text-lg md:text-xl text-gray-400 font-medium max-w-2xl border-l-4 border-red-600 pl-4 text-left">
