  ...
  return (
    <SyllabusLayout
      meta={{
        slug: "dfir",
        title: "DFIR",
        subtitle: "Digital Forensics Track",
        phase: "Phase 2 · Specialization",
        duration: "3 Months · 12 Weeks",
        tagline: "The science of investigating breaches. Master disk forensics, memory analysis, and enterprise incident response.",
        certCode: "ZDF",
        certName: "Zharnyx Digital Forensics",
      }}
