  ...
  return (
    <SyllabusLayout
      meta={{
        ...
        tagline: "Think like an attacker. Master web, network, and Active Directory penetration testing with industry-standard tools.",
        certCode: "ZPT",
        certName: "Zharnyx Penetration Tester",
      }}
