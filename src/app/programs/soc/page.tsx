...
import { Shield, Lock, Terminal, ShieldAlert, Cpu, Network, Code, Server, CheckSquare, ArrowRight, PlayCircle, BookOpen, Briefcase, Target } from "lucide-react";
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col items-center gap-20">
        ...
        <section className="flex flex-col items-center text-center max-w-3xl space-y-6">
          ...
          <h1 ref={headingRef} className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white uppercase leading-tight">
            SOC Analysis <span className="text-red-500">Core Track</span>
          </h1>
        </section>
        ...
        <div ref={contentRef} className="opacity-0 flex flex-col items-center gap-20 w-full">
          <p className="text-lg md:text-xl text-gray-400 font-medium border-l-4 border-red-600 pl-4 text-left max-w-3xl">
            3 Months · Weeks 1–12 · Become the defender. Master SIEM platforms, threat hunting, and real-time incident response in live SOC environments. Target Role: SOC Analyst.
          </p>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                This track is engineered to prepare you for the upcoming <span className="text-white font-bold">ZSA</span> (Zharnyx SOC Analyst) certification — a 100% hands-on, no-MCQ practical exam.
              </p>
            </div>
